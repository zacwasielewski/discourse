...
describe "users/omniauth_callbacks/complete.html.erb" do
  ...
  it "renders boulderproblems data " do
    assign(:data, {username: "username", :auth_provider=>"Boulder Problems", :awaiting_activation=>true})
    ...
    rendered_data["username"].should eq("username")
    rendered_data["auth_provider"].should eq("Boulder Problems")
    rendered_data["awaiting_activation"].should eq(true)
  end
